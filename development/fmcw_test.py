...
class fmcw_test(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "FMCW Test", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("FMCW Test")
        ...
        self.settings = Qt.QSettings("GNU Radio", "fmcw_test")
        ...
        self.qtgui_time_sink_x_0_1.set_y_label("f", "t")
        ...
        self.blocks_vco_c_0 = blocks.vco_c(samp_rate, (2*np.pi*(max_freq)), 1)
...
def main(top_block_cls=fmcw_test, options=None):
