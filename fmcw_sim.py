...
class fmcw_sim(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Variables
        ##################################################
        self.samp_rate = samp_rate = int(7e6)
        self.max_freq = max_freq = samp_rate*0.3
        self.t_chirp = t_chirp = 2
        self.min_freq = min_freq = -max_freq
        self.k_bins = k_bins = 2**18
        self.c = c = 300000000
        self.system_delay = system_delay = 0
        self.radio_tx_gain = radio_tx_gain = 40
        ...
        self.blocks_delay_0_0 = blocks.delay(gr.sizeof_float*1, (samp_rate*3))
        self.blocks_delay_0 = blocks.delay(gr.sizeof_gr_complex*1, system_delay)
        ...
        self.connect((self.blocks_vco_c_0, 0), (self.qtgui_freq_sink_x_0_0_0, 1))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.set_max_freq(self.samp_rate*0.3)
        self.analog_sig_source_x_0.set_sampling_freq(self.samp_rate)
        self.blocks_delay_0_0.set_dly(int((self.samp_rate*3)))
    ...
    def set_system_delay(self, system_delay):
        self.system_delay = system_delay
        self.blocks_delay_0.set_dly(int(self.system_delay))
