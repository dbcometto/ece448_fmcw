...
class fmcw_sim(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.t_chirp = t_chirp = 0.00005
        self.min_freq = min_freq = 0
        self.max_freq = max_freq = samp_rate/2
        ...
        self._distance_m_range = qtgui.Range(0, distance_max_m, 1, 100, 200)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.set_max_freq(self.samp_rate/2)
